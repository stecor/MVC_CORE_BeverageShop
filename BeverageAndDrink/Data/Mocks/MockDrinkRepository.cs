            ...
            get
            {
                return new List<Drink>
                {
                    new Drink {
                        ...
                        ImageUrl = "..\\images\\beerL_2.jpg",
                        InStock = true,
                        IsPreferredDrink = true,
                        ImageThumbnailUrl = "..\\images\\beerS_1.jpg"
                    },
                    new Drink {
                        Name = "Rum & Coke",
                        ...
                        Category =  _categoryRepository.Categories.First(),
                        ImageUrl = "..\\images\\rumCokeL.jpg",
                        InStock = true,
                        IsPreferredDrink = false,
                        ImageThumbnailUrl = "..\\images\\rumAndCokeS.jpg"
                    },
                    new Drink {
                        Name = "Tequila ",
                        ...
                        Category =  _categoryRepository.Categories.First(),
                        ImageUrl = "..\\images\\tequilaL.jpg",
                        InStock = true,
                        IsPreferredDrink = false,
                        ImageThumbnailUrl = "..\\images\\tequilaS.jpg"
                    },
                    new Drink
                    {
                        Name = "Juice ",
